...
EquipHats("-gh 5269023723 28171753 451220849 62234425 63690008 62724852 48474294 4622081834 4822592866 4094878701")
...
local Hats = { torso1 = Character:WaitForChild("No Speak Monkey"),
             ...
             rightleg = Character:WaitForChild("LavanderHair"),
             leftleg = Character:WaitForChild("Pink Hair"),
             rightabs = Character:WaitForChild("International Fedora"),
...
EquipHats("-gh 17614451 4246228452 3992084515 63690008")
...
EquipHats("-gh 4025460572 1532389 191101707 4332375148 750 4708069539")
...
Bike.MouseButton1Down:connect(function()
    EquipHats("-gh 191101707 5063566353")
plr = game.Players.LocalPlayer
char = plr.Character
torso = char.Torso
local jit = Vector3.new(30,0,0)
...
_911Plane.MouseButton1Down:connect(function()
    EquipHats("-gh 4690305028 4627469896 4623675984 4602619613 4315489767 4794315940 4461505493 4461584953")
local jit = Vector3.new(30,0,0)
local c = game.Players.LocalPlayer.Character
...
EquipHats("-gh 4998547654 28171753 20372960 62234425 63690008 62724852 451220849")
 local tog = true
 local move = false
local Player = game:GetService("Players").LocalPlayer
local Character = Player.Character
...
EquipHats("-gh 4435389917 750 191101707")
plr = game.Players.LocalPlayer
char = plr.Character
...
EquipHats("-gh 3806215779 5132802731 31151864 27345567 24826811 24826755")
 local tog = true
 local move = false
local Player = game:GetService("Players").LocalPlayer
local Character = Player.Character
...
Hoverboard.Text = "Hoverboard [a lil broken]"
...
EquipHats("-gh 28171753 191101707 451220849 63690008")
...
EquipHats("-gh 4735336570 4735272012")
local l = game.Players.LocalPlayer
local c = game.Players.LocalPlayer.Character
local jit = Vector3.new(30,0,0)
...
Welcome.Position = UDim2.new(0.31099999, 0, 0, 0, 0)
Welcome.Size = UDim2.new(0, 225, 0, 27)
Welcome.Font = Enum.Font.SourceSans
Welcome.Text = 'Adjusted for "Just a baseplate", by vesersus'
